...
pars_tte <- read_csv(here::here(root_src, "pars_tte_ind.csv"))
pars_tte_slopes <- read_csv(here::here(root_src, "pars_tte_slopes_ind.csv"))


root_tar <- here::here("out", "gen_ind")
